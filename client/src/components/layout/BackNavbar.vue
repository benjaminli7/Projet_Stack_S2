  ...
  <aside id="logo-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-100 dark:bg-gray-800 flex flex-col ">
      ...
      <ul class="space-y-2">
        ...
        <li>
          <router-link to="/back/reports" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
